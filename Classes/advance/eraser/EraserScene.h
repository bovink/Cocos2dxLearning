...
class LatticePoint {
private:
    static void pushAxisPoints(int x, std::vector<Vector2> &points) {
    ...
    static void pushDiagonalPoints(int i, std::vector<Vector2> &points) {
    ...
    static void pushQuadrantsPoints(int i, int j, std::vector<Vector2> &points) {
...
public:
    ...
    static void getFromCircle(int radius, std::vector<Vector2> &points) {
        assert(radius >= 0);
    ...
    static void getFromRing(int bigradius, int smallradius, std::vector<Vector2> &points) {
