...
void DatabaseModule::createTable() {
    sqlite3 *pdb = NULL;
    openDatabase(&pdb);
...
void DatabaseModule::insertData() {
    sqlite3 *pdb = NULL;
    openDatabase(&pdb);
...
void DatabaseModule::queryData2() {
    sqlite3 *pdb = NULL;
    openDatabase(&pdb);
...
void DatabaseModule::deleteData() {
...
void DatabaseModule::modifyData() {
